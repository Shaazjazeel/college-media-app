...
public class Chat1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterMessages = new MessagesAdapter(Chat1.this);
...
//                    String url = "http://" + hu + ":8000/add_chat";
                    String url= sh.getString("url","")+"/add_chat1";
...
//                            params.put( "toid", toid );               //follower_id
                            ...
                            params.put( "following_id",sh.getString("following_id","") );
...
//                String chatURL = "http://" + hu + ":3000/view_chat";
                String chatURL= sh.getString("url","")+"/view_chat1";
...
//                        params.put( "toid", toid);
    ...
    public void onBackPressed() {
        ...
        startActivity( new Intent( Chat1.this,view_follower_list.class ) );
    }
}