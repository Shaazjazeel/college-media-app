...
public class view_comment_otherpost extends AppCompatActivity {
    ListView li;
...
FloatingActionButton f1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_comment_otherpost);
        ...
        li=findViewById(R.id.joooo);

        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ip", "");
        url = sh.getString("url", "") + "/view_comment_otherspost";
...
//                                }
                                ...
                                li.setAdapter(new custom_view_comment_otherpost(getApplicationContext(),cmdid,date,image,name,comment));
