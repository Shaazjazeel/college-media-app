...
public class custom_view_mypost_comment extends BaseAdapter {
    String[]cmdid,date,image,name,comment;
    private Context context;

    public custom_view_mypost_comment(Context applicationContext, String[] cmdid, String[] date, String[] image, String[] name, String[] comment) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            gridView = inflator.inflate(R.layout.activity_custom_view_mypost_comment, null);

        } else {
            gridView = (View) view;

        }
        TextView tv1 = (TextView) gridView.findViewById(R.id.cdate);
