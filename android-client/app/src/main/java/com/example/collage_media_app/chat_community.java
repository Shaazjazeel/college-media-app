...
public class chat_community extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterMessages = new MessagesAdapter(chat_community.this);
...
//        toid=custom_view_follower_list.expid[custom_view_follower_list.posi];
...
//                    String url = "http://" + hu + ":8000/add_chat";
                    String url= sh.getString("url","")+"/and_add_chat_community";
...
//                            params.put( "lid", id );                  //login_id
//                            params.put( "toid", toid );               //follower_id
                            params.put( "message", msggg );
                            params.put( "lid",sh.getString("lid","") );
                            params.put( "cid", sh.getString("com_id","") );
...
//                String chatURL = "http://" + hu + ":3000/view_chat";
                String chatURL= sh.getString("url","")+"/and_view_chat_community" +
                        "";
...
//                        params.put( "toid", toid);
    ...
    public void onBackPressed() {
        ...
        startActivity( new Intent( chat_community.this,view_follower_list.class ) );
    }
}