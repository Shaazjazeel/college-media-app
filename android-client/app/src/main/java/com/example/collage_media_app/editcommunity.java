...
public class editcommunity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comname=findViewById(R.id.editTextTextPersonName29);
        b1=findViewById(R.id.button22);

        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        url=sh.getString("url","")+"/and_editcommunity";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                comname.setText(jsonObj.getString("name"));
...
//                params.put("comname",);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                url=sh.getString("url","")+"/editcommunitypost";
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                        ...
                                        Toast.makeText(getApplicationContext(), "Rename successfully", Toast.LENGTH_LONG).show();
