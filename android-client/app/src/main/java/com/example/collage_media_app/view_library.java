...
public class view_library extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        li=findViewById(R.id.vvvv);

        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ip", "");
        url = sh.getString("url", "") + "/and_viewlibrary";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                lib_id=new String[js.length()];
//                                library=new String[js.length()];
...
//                                }
                                ...
                                li.setAdapter(new custom_view_library(getApplicationContext(),lib_id,name,place,email,phone));
