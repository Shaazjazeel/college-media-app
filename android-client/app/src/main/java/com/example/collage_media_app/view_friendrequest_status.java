...
public class view_friendrequest_status extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_friendrequest_status);
        ...
        f1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(getApplicationContext(),view_other_user.class);
                startActivity(i);
            }
        });
        li=findViewById(R.id.rest);
        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ip", "");
        url = sh.getString("url", "") + "/and_viewfriendrequeststatus";
...
//                                }
                                ...
                                li.setAdapter(new custom_view_friendrequest_status(getApplicationContext(),req_id,name,image,department,status));
