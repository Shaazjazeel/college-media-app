...
public class custom_view_follower_list extends BaseAdapter {
    String[] follower_id,image,name,senderid;
    private Context context;

    public custom_view_follower_list(Context applicationContext, String[] follower_id, String[] image, String[] name,String[] senderid) {
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_follower_list,null);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(context, ""+senderid[a], Toast.LENGTH_SHORT).show();
                SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(context);
                SharedPreferences.Editor ed = sh.edit();
                ed.putString("follower_id", follower_id[a]);
                ed.commit();
...
//                Toast.makeText(context, ""+id[a], Toast.LENGTH_SHORT).show();
                SharedPreferences sh= PreferenceManager.getDefaultSharedPreferences(context);
                String url = sh.getString("url","") + "/unfollow_follower";//it not going any other pages
                ...
                StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        params.put("follower_id",follower_id[a]);//cart id
